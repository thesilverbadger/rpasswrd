...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { code: @code.code, is_deleted: @code.is_deleted, password: @code.password, username: @code.username }
    end
  ...
  test "should update code" do
    put :update, id: @code, code: { code: @code.code, is_deleted: @code.is_deleted, password: @code.password, username: @code.username }
    assert_redirected_to code_path(assigns(:code))
  end
